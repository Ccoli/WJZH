...
namespace Tuby.Api.Repository
{
    public class SoldierInfoRepository : BaseRepository<SoldierInfoView>, ISoldierInfoRepository
    {
        ...
        {
            return await QueryMuch<d_soldier, b_pap_post, b_pap_rank, b_health, b_soldier_state, b_education_level, b_politic_role, b_marial_status, SoldierInfoView>(
                   (dsoldeir, bppost, bprank, bhealth, bsstate, bel, bpr, bms) => new object[] {
               ...
               JoinType.Left,dsoldeir.SoilderStateID ==bsstate.ID,
                JoinType.Left,dsoldeir.EducationID ==bel.ID,
                 ...
                 JoinType.Left,dsoldeir.IsMarriageID ==bms.ID
                   ...
                   (dsoldeir, bppost, bprank, bhealth, bsstate, bel, bpr,bms) => dsoldeir.Name==name
                   );
        }
    }
}
