...
{	
    ...
    { 
        ...
        /// </summary>
        /// <returns></returns>
        public d_target_camera_record_peopleController(Id_target_camera_record_peopleServices d_target_camera_record_peopleServices)
        {
            _d_target_camera_record_peopleServices = d_target_camera_record_peopleServices;
        }
		/// <summary>
		/// api/d_target_camera_record_people 查询所有数据
		/// </summary>	
		 [HttpGet]
        ...
        /// <summary>
		/// api/d_target_camera_record_people/{id} 根据id查询数据
		/// </summary>
        [HttpGet("{id}")]
        ...
        /// <summary>
		/// api/d_target_camera_record_people post添加数据
		/// </summary>
        [HttpPost]
       public async Task<MessageModel<string>> Post([FromBody] d_target_camera_record_people d_target_camera_record_people)
        {
         ...
         /// <summary>
		/// api/d_target_camera_record_people put更新数据
		/// </summary>
        [HttpPut]
        public async Task<MessageModel<string>> Update([FromBody] d_target_camera_record_people d_target_camera_record_people)
        {
            ...
            if (d_target_camera_record_people != null && d_target_camera_record_people.ID > 0)
            {
                ...
                if (data.success)
                {
                    data.response = "id为" +d_target_camera_record_people.ID.ToString() + "的数据更新成功";
                    data.msg = "更新成功";
                }
                else
                {
                    data.response = "id为" +d_target_camera_record_people.ID.ToString() + "的数据不存在";
                }
            }
        ...
        /// <summary>
		/// api/d_target_camera_record_people/delete get删除数据
		/// </summary>
        [HttpGet]
        [Route("delete")]
