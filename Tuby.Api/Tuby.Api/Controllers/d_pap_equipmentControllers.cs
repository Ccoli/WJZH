...
{	
    ...
    { 
		 Id_pap_equipmentServices d_pap_equipmentServices=new d_pap_equipmentServices();
		 [HttpGet]
        public async Task<List<d_pap_equipment>> Get()
        {
            return await d_pap_equipmentServices.Query();
        }
        ...
        {
            return await d_pap_equipmentServices.Query(c => c.ID == id);
        }
