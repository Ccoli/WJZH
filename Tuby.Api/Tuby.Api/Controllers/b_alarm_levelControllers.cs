...
{	
    ...
    { 
		 Ib_alarm_levelServices b_alarm_levelServices=new b_alarm_levelServices();
		 [HttpGet]
        public async Task<List<b_alarm_level>> Get()
        {
            return await b_alarm_levelServices.Query();
        }
        ...
        {
            return await b_alarm_levelServices.Query(c => c.ID == id);
        }
