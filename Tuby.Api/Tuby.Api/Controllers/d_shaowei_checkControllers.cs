...
{	
    ...
    { 
		 Id_shaowei_checkServices d_shaowei_checkServices=new d_shaowei_checkServices();
		 [HttpGet]
        public async Task<List<d_shaowei_check>> Get()
        {
            return await d_shaowei_checkServices.Query();
        }
        ...
        {
            return await d_shaowei_checkServices.Query(c => c.ID == id);
        }
