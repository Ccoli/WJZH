...
{	
    ...
    { 
		 Id_target_car_whitelistServices d_target_car_whitelistServices=new d_target_car_whitelistServices();
		 [HttpGet]
        public async Task<List<d_target_car_whitelist>> Get()
        {
            return await d_target_car_whitelistServices.Query();
        }
        ...
        {
            return await d_target_car_whitelistServices.Query(c => c.ID == id);
        }
