...
{	
    ...
    { 
		 Ib_target_people_typeServices b_target_people_typeServices=new b_target_people_typeServices();
		 [HttpGet]
        public async Task<List<b_target_people_type>> Get()
        {
            return await b_target_people_typeServices.Query();
        }
        ...
        {
            return await b_target_people_typeServices.Query(c => c.ID == id);
        }
