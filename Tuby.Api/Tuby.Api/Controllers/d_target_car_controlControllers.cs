...
{	
    ...
    { 
		 Id_target_car_controlServices d_target_car_controlServices=new d_target_car_controlServices();
		 [HttpGet]
        public async Task<List<d_target_car_control>> Get()
        {
            return await d_target_car_controlServices.Query();
        }
        ...
        {
            return await d_target_car_controlServices.Query(c => c.ID == id);
        }
