...
{	
    ...
    { 
		 Ib_marial_statusServices b_marial_statusServices=new b_marial_statusServices();
		 [HttpGet]
        public async Task<List<b_marial_status>> Get()
        {
            return await b_marial_statusServices.Query();
        }
        ...
        {
            return await b_marial_statusServices.Query(c => c.ID == id);
        }
