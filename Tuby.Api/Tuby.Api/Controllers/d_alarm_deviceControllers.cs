...
{	
    ...
    { 
		 Id_alarm_deviceServices d_alarm_deviceServices=new d_alarm_deviceServices();
		 [HttpGet]
        public async Task<List<d_alarm_device>> Get()
        {
            return await d_alarm_deviceServices.Query();
        }
        ...
        {
            return await d_alarm_deviceServices.Query(c => c.ID == id);
        }
