...
{	
    ...
    { 
		 Ib_soldier_stateServices b_soldier_stateServices=new b_soldier_stateServices();
		 [HttpGet]
        public async Task<List<b_soldier_state>> Get()
        {
            return await b_soldier_stateServices.Query();
        }
        ...
        {
            return await b_soldier_stateServices.Query(c => c.ID == id);
        }
