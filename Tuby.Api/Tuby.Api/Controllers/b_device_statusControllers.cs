...
{	
    ...
    { 
		 Ib_device_statusServices b_device_statusServices=new b_device_statusServices();
		 [HttpGet]
        public async Task<List<b_device_status>> Get()
        {
            return await b_device_statusServices.Query();
        }
        ...
        {
            return await b_device_statusServices.Query(c => c.ID == id);
        }
