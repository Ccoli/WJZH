...
{	
    ...
    { 
		 Id_pap_matterServices d_pap_matterServices=new d_pap_matterServices();
		 [HttpGet]
        public async Task<List<d_pap_matter>> Get()
        {
            return await d_pap_matterServices.Query();
        }
        ...
        {
            return await d_pap_matterServices.Query(c => c.ID == id);
        }
