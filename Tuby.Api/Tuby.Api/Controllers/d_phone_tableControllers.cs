...
{	
    ...
    { 
		 Id_phone_tableServices d_phone_tableServices=new d_phone_tableServices();
		 [HttpGet]
        public async Task<List<d_phone_table>> Get()
        {
            return await d_phone_tableServices.Query();
        }
        ...
        {
            return await d_phone_tableServices.Query(c => c.ID == id);
        }
