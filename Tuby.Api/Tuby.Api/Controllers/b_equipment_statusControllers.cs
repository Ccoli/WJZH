...
{	
    ...
    { 
		 Ib_equipment_statusServices b_equipment_statusServices=new b_equipment_statusServices();
		 [HttpGet]
        public async Task<List<b_equipment_status>> Get()
        {
            return await b_equipment_statusServices.Query();
        }
        ...
        {
            return await b_equipment_statusServices.Query(c => c.ID == id);
        }
