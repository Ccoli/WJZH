...
{	
    ...
    { 
		 Ib_target_people_security_levelServices b_target_people_security_levelServices=new b_target_people_security_levelServices();
		 [HttpGet]
        public async Task<List<b_target_people_security_level>> Get()
        {
            return await b_target_people_security_levelServices.Query();
        }
        ...
        {
            return await b_target_people_security_levelServices.Query(c => c.ID == id);
        }
