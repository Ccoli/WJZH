...
{	
    ...
    { 
		 Iar_usergroup_ui_accessServices ar_usergroup_ui_accessServices=new ar_usergroup_ui_accessServices();
		 [HttpGet]
        public async Task<List<ar_usergroup_ui_access>> Get()
        {
            return await ar_usergroup_ui_accessServices.Query();
        }
        ...
        {
            return await ar_usergroup_ui_accessServices.Query(c => c.UserGroupID == id);
        }
