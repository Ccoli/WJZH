...
{	
    ...
    { 
		 Ib_camera_typeServices b_camera_typeServices=new b_camera_typeServices();
		 [HttpGet]
        public async Task<List<b_camera_type>> Get()
        {
            return await b_camera_typeServices.Query();
        }
        ...
        {
            return await b_camera_typeServices.Query(c => c.ID == id);
        }
