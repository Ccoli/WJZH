...
{	
    ...
    { 
		 Ib_administrative_divisionServices b_administrative_divisionServices=new b_administrative_divisionServices();
		 [HttpGet]
        public async Task<List<b_administrative_division>> Get()
        {
            return await b_administrative_divisionServices.Query();
        }
        ...
        {
            return await b_administrative_divisionServices.Query(c => c.ID == id);
        }
