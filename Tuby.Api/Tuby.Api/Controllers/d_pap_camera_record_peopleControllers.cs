...
{	
    ...
    { 
		 Id_pap_camera_record_peopleServices d_pap_camera_record_peopleServices=new d_pap_camera_record_peopleServices();
		 [HttpGet]
        public async Task<List<d_pap_camera_record_people>> Get()
        {
            return await d_pap_camera_record_peopleServices.Query();
        }
        ...
        {
            return await d_pap_camera_record_peopleServices.Query(c => c.ID == id);
        }
