...
{	
    ...
    { 
		 Ib_education_levelServices b_education_levelServices=new b_education_levelServices();
		 [HttpGet]
        public async Task<List<b_education_level>> Get()
        {
            return await b_education_levelServices.Query();
        }
        ...
        {
            return await b_education_levelServices.Query(c => c.ID == id);
        }
