...
{	
    ...
    { 
		 Id_target_camera_record_carServices d_target_camera_record_carServices=new d_target_camera_record_carServices();
		 [HttpGet]
        public async Task<List<d_target_camera_record_car>> Get()
        {
            return await d_target_camera_record_carServices.Query();
        }
        ...
        {
            return await d_target_camera_record_carServices.Query(c => c.ID == id);
        }
