...
{	
    ...
    { 
		 Ib_politic_roleServices b_politic_roleServices=new b_politic_roleServices();
		 [HttpGet]
        public async Task<List<b_politic_role>> Get()
        {
            return await b_politic_roleServices.Query();
        }
        ...
        {
            return await b_politic_roleServices.Query(c => c.ID == id);
        }
