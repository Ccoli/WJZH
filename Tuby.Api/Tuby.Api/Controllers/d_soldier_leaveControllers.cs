...
{	
    ...
    { 
		 Id_soldier_leaveServices d_soldier_leaveServices=new d_soldier_leaveServices();
		 [HttpGet]
        public async Task<List<d_soldier_leave>> Get()
        {
            return await d_soldier_leaveServices.Query();
        }
        ...
        {
            return await d_soldier_leaveServices.Query(c => c.ID == id);
        }
