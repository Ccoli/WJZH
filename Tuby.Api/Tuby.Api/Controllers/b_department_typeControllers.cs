...
{	
    ...
    { 
		 Ib_department_typeServices b_department_typeServices=new b_department_typeServices();
		 [HttpGet]
        public async Task<List<b_department_type>> Get()
        {
            return await b_department_typeServices.Query();
        }
        ...
        {
            return await b_department_typeServices.Query(c => c.ID == id);
        }
