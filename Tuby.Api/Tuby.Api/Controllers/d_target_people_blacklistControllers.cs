...
{	
    ...
    { 
		 Id_target_people_blacklistServices d_target_people_blacklistServices=new d_target_people_blacklistServices();
		 [HttpGet]
        public async Task<List<d_target_people_blacklist>> Get()
        {
            return await d_target_people_blacklistServices.Query();
        }
        ...
        {
            return await d_target_people_blacklistServices.Query(c => c.ID == id);
        }
