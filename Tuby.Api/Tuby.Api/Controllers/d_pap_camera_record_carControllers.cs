...
{	
    ...
    { 
		 Id_pap_camera_record_carServices d_pap_camera_record_carServices=new d_pap_camera_record_carServices();
		 [HttpGet]
        public async Task<List<d_pap_camera_record_car>> Get()
        {
            return await d_pap_camera_record_carServices.Query();
        }
        ...
        {
            return await d_pap_camera_record_carServices.Query(c => c.ID == id);
        }
