...
{	
    ...
    { 
		 Ib_phone_table_typeServices b_phone_table_typeServices=new b_phone_table_typeServices();
		 [HttpGet]
        public async Task<List<b_phone_table_type>> Get()
        {
            return await b_phone_table_typeServices.Query();
        }
        ...
        {
            return await b_phone_table_typeServices.Query(c => c.ID == id);
        }
