...
{	
    ...
    { 
		 Ib_equipment_typeServices b_equipment_typeServices=new b_equipment_typeServices();
		 [HttpGet]
        public async Task<List<b_equipment_type>> Get()
        {
            return await b_equipment_typeServices.Query();
        }
        ...
        {
            return await b_equipment_typeServices.Query(c => c.ID == id);
        }
