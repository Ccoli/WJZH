...
{	
    ...
    { 
		 Ib_leave_reasonServices b_leave_reasonServices=new b_leave_reasonServices();
		 [HttpGet]
        public async Task<List<b_leave_reason>> Get()
        {
            return await b_leave_reasonServices.Query();
        }
        ...
        {
            return await b_leave_reasonServices.Query(c => c.ID == id);
        }
