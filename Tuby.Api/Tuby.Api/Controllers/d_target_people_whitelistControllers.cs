...
{	
    ...
    { 
		 Id_target_people_whitelistServices d_target_people_whitelistServices=new d_target_people_whitelistServices();
		 [HttpGet]
        public async Task<List<d_target_people_whitelist>> Get()
        {
            return await d_target_people_whitelistServices.Query();
        }
        ...
        {
            return await d_target_people_whitelistServices.Query(c => c.ID == id);
        }
