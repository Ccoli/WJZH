...
{	
    ...
    { 
		 readonly Ia_ui_accessServices _a_ui_accessServices;

		 /// <summary>
        /// 构造函数
        /// </summary>
        /// <returns></returns>
        public a_ui_accessController(Ia_ui_accessServices a_ui_accessServices)
        {
        ...
        [HttpGet]
        [Route("getpage")]
        public async Task<PageModel<a_ui_access>> GetPage(int page)
        {
            return await _a_ui_accessServices.Query("", page, 10, "");
        }
       ...
       public async Task<MessageModel<string>> Post([FromBody] a_ui_access a_ui_access)
        ...
        {
            var flag = (await _a_ui_accessServices.DeleteByIds(id));
            var data = new MessageModel<string>();
            data.success = flag;
            if (flag)
            {
